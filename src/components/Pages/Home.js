...
import { Button, Typography, Container, TextField, Table, TableHead, TableBody, TableRow, TableCell } from '@mui/material';
        ...
        <TableBody>
          {filteredData.map((productItem, i) => (
            <TableRow key={i}>
              ...
              <TableCell>
                <Button component={Link} to={`/updateproduct/${i}`} variant="contained" color="primary" sx={{ mr: 1 }}>Update</Button>
